...
export default defineConfig(({ mode }) => {
  ...
  define: {
    'import.meta.env.VITE_SUPABASE_URL': JSON.stringify('https://ammaosmkgwkamfjhcxik.supabase.co'),
    'import.meta.env.VITE_SUPABASE_ANON_KEY': JSON.stringify('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFtbWFvc21rZ3drYW1mamhjeGlrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTY2Mjc1ODcsImV4cCI6MjA3MjIwMzU4N30.fJYBJGdPikihQiWvFAc7fAnE9-TQxOtws6etFMRwgcI'),
